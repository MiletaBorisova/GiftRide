...
namespace GiftRide.Infrastructure.Migrations
{
    ...
    [Migration("20260317130801_AddContactEntityUpdate")]
    partial class AddContactEntityUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AppliedPromoDiscountPercent")
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.FaqEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.PromoCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Validity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Cart", b =>
                {
                    b.HasOne("GiftRide.Infrastructure.Data.Entities.ApplicationUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("GiftRide.Infrastructure.Data.Entities.Cart", "UserId");
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.CartItem", b =>
                {
                    b.HasOne("GiftRide.Infrastructure.Data.Entities.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GiftRide.Infrastructure.Data.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Product", b =>
                {
                    b.HasOne("GiftRide.Infrastructure.Data.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GiftRide.Infrastructure.Data.Entities.Validity", "Validity")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("GiftRide.Infrastructure.Data.Entities.Voucher", b =>
                {
                    b.HasOne("GiftRide.Infrastructure.Data.Entities.Order", "Order")
                        .WithMany("Vouchers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GiftRide.Infrastructure.Data.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
